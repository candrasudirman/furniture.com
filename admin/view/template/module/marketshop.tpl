...
foreach ($languages as $language) { 
    ...
    if(empty($marketshop_powered[$language["language_id"]])){$marketshop_powered[$language["language_id"]] ="Marketshop Theme &copy; 2014, Theme By Harnish Design";}
          ...
          <div class="col-sm-10">
            <div class="tab-content">
              ...
              <div id="tab_layout" class="tab-pane">
                <table class="table table-hover">
                  <!--<tr>
            <td style="width:30%;">Responsive Design <a class="marketshop_help" target="_blank" href="../catalog/view/theme/marketshop/image/help/option_7.jpg">?</a></td>
            <td><select name="marketshop_responsive_design" class="form-control">
