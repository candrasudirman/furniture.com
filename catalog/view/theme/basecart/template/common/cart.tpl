    ...
    <div>
      <table class="table table-condensed">
        ...
        <tr>
          ...
          <td class="text-center"><button type="button" onclick="cart.remove('<?php echo $product['key']; ?>');" title="<?php echo $button_remove; ?>" class="btn btn-danger btn-xs"><i class="fa fa-close"></i></button></td>
        </tr>
        <?php } ?>
      ...
      <div>
        ...
        <div class="row">
          <div class="col-sm-12">
            ...
            <a class="btn btn-success btn-block" href="<?php echo $checkout; ?>"><?php echo $text_checkout; ?></a>
          </div>
        </div>
      </div>
    </li>
