...
<?php global $config; if($config->get('marketshop_search_auto_complete')== 1) { ?>
...
<style type="text/css">
body {
<?php if($config->get('marketshop_background_color')!='') {
...
background-image: url("<?php echo $path_image . $config->get('marketshop_custom_image') ?>"); ?>; background-position:<?php echo $config->get('marketshop_custom_image_position'); ?>; background-repeat:<?php echo $config->get('marketshop_custom_image_repeat'); ?>; background-attachment:<?php echo $config->get('marketshop_custom_image_attachment'); ?>;
<?php
}
...
.pagination > .active > a, .pagination > .active > span, .pagination > .active > a:hover, .pagination > .active > span:hover, .pagination > .active > a:focus, .pagination > .active > span:focus {background-color: <?php echo $config->get('marketshop_general_links_color');?>; border-color: <?php echo $config->get('marketshop_general_links_color');?>;}
<?php
}
if($config->get('marketshop_body_text_color')!='') {?>
body {color: <?php echo $config->get('marketshop_body_text_color'); ?>;}
<?php
}
if($config->get('marketshop_general_links_color')!='') {?>
a, a b, .articleHeader span a, .pagination > li > a {color: <?php echo $config->get('marketshop_general_links_color'); ?>;}

<?php
}
if($config->get('marketshop_general_links_color')!='') {?>
.owl-carousel.slideshowhome .owl-controls .owl-buttons .owl-prev:hover, .owl-carousel.slideshowhome .owl-controls .owl-buttons .owl-next:hover, .nivo-directionNav .nivo-nextNav:hover, .nivo-directionNav .nivo-prevNav:hover {background-color: <?php echo $config->get('marketshop_general_links_color'); ?>;}

<?php
}
if($config->get('marketshop_general_links_hover_color')!='') {?>
a:hover, a b:hover, .category .tabs li a:hover, .sitemap li a:hover, .pagination > li > a:hover, .breadcrumb a:hover, .login-content .right a:hover, .box-category a:hover, .list-item a:hover, #blogArticle .articleHeader h1 a:hover, #blogCatArticles .articleHeader h3 a:hover, .tags-update .tags a:hover, .articleHeader span a:hover {color: <?php echo $config->get('marketshop_general_links_hover_color'); ?>;}
<?php
}
if($config->get('marketshop_heading_color')!='') {?>
#container h1{color: <?php echo $config->get('marketshop_heading_color'); ?>;}
<?php
}
if($config->get('marketshop_secondary_heading_color')!='') {?>
#container h2, #container h3, .product-tab .htabs a, .product-tab .tabs li a{color: <?php echo $config->get('marketshop_secondary_heading_color'); ?>;}
<?php
}
if($config->get('marketshop_secondary_heading_border_color')!='') {?>
#container h2, #container h3, .product-tab .htabs a, .product-tab .tabs li.active a, .product-tab .tabs, .category .tabs li.active a{border-color: <?php echo $config->get('marketshop_secondary_heading_border_color'); ?>;}

/*===== TOP BAR =====*/
<?php
}
if($config->get('marketshop_top_bar_bg_color')!='') {?>
#header .htop, .left-top{background-color:<?php echo $config->get('marketshop_top_bar_bg_color'); ?>;}
<?php
}
if($config->get('marketshop_top_bar_link_color')!='') {?>
#header .links > ul > li.mobile, #header .links > ul > li > a, #language span, #currency span, #header #top-links > ul > li > a, .drop-icon{color:<?php echo $config->get('marketshop_top_bar_link_color'); ?>;}
<?php
}
if($config->get('marketshop_top_bar_link_color')!='') {?>
#header .links > ul > li.wrap_custom_block a b{border-top-color:<?php echo $config->get('marketshop_top_bar_link_color'); ?>;}
<?php
}
if(($config->get('marketshop_top_bar_link_separator_style')!='') && ($config->get('marketshop_top_bar_link_separator_color')!='')) {?>
#header .links > ul > li, #header #top-links > ul > li{border-left:1px <?php echo $config->get('marketshop_top_bar_link_separator_style')?> <?php echo $config->get('marketshop_top_bar_link_separator_color')?>}
<?php
}
if(($config->get('marketshop_top_bar_link_separator_style')!='') && ($config->get('marketshop_top_bar_link_separator_color')!='')) {?>
#header .links, #language, #currency, #header #top-links{border-right:1px <?php echo $config->get('marketshop_top_bar_link_separator_style')?> <?php echo $config->get('marketshop_top_bar_link_separator_color')?>}
<?php
}
if($config->get('marketshop_top_bar_sub_link_color')!='') {?>
#top .dropdown-menu li a, #currency ul li .currency-select{color:<?php echo $config->get('marketshop_top_bar_sub_link_color'); ?>;}
<?php
}
if($config->get('marketshop_top_bar_sub_link_hover_color')!='') {?>
#top .dropdown-menu li a:hover, #currency ul li .currency-select:hover{color:<?php echo $config->get('marketshop_top_bar_sub_link_hover_color'); ?>;}
<?php
}
if($config->get('marketshop_mini_cart_icon_color')!='') {?>
#header #cart .heading h4{background-color:<?php echo $config->get('marketshop_mini_cart_icon_color'); ?>;}
<?php
}
if($config->get('marketshop_mini_cart_icon_color')!='') {?>
#header #cart .heading h4:after, #header #cart .heading h4:before, #header #cart .dropdown-menu{border-color:<?php echo $config->get('marketshop_mini_cart_icon_color'); ?>;}
<?php
}
if($config->get('marketshop_mini_cart_icon_color')!='') {?>
#header #cart.open .heading span:after{border-color:transparent transparent <?php echo $config->get('marketshop_mini_cart_icon_color'); ?>;}
<?php
}
if($config->get('marketshop_mini_cart_link_color')!='') {?>
#header #cart .heading{color:<?php echo $config->get('marketshop_mini_cart_link_color'); ?>;}
<?php
}
if($config->get('marketshop_mini_cart_active_link_color')!='') {?>
#header #cart.open .heading{color:<?php echo $config->get('marketshop_mini_cart_active_link_color'); ?>;}


<?php
}
if($config->get('marketshop_search_bar_background_color')!='') {?>
#header #search input{background-color:<?php echo $config->get('marketshop_search_bar_background_color'); ?>;}
<?php
}
if($config->get('marketshop_search_bar_border_color')!='') {?>
#header #search input{border-color:<?php echo $config->get('marketshop_search_bar_border_color'); ?>;}
<?php
}
if($config->get('marketshop_search_bar_text_color')!='') {?>
#header #search input{color:<?php echo $config->get('marketshop_search_bar_text_color'); ?>;}
<?php
}
if($config->get('marketshop_search_bar_border_hover_color')!='') {?>
#header #search input:focus, #header #search input:hover{border-color:<?php echo $config->get('marketshop_search_bar_border_hover_color'); ?>;}
<?php
}
if($config->get('marketshop_search_bar_icon_color')!='') {?>
#header .button-search{color:<?php echo $config->get('marketshop_search_bar_icon_color'); ?>;}
...
#menu {background-color: <?php echo $config->get('marketshop_menu_bg_color'); ?>;}
<?php
}
if($config->get('marketshop_menu_link_color')!='') {?>
#menu .nav > li > a, #menu .navbar-header > span{color: <?php echo $config->get('marketshop_menu_link_color'); ?>;}
<?php
}
if($config->get('marketshop_menu_link_color')!='') {?>
#menu .navbar-header > span > b:before{border-color: transparent transparent <?php echo $config->get('marketshop_menu_link_color'); ?>;}
<?php
}
if($config->get('marketshop_menu_link_color')!='') {?>
#menu .navbar-header > span > b:after{border-color: <?php echo $config->get('marketshop_menu_link_color'); ?> transparent transparent;}

<?php
}
if($config->get('marketshop_menu_link_hover_color')!='') {?>
#menu .nav > li:hover > a {color: <?php echo $config->get('marketshop_menu_link_hover_color'); ?>;}
<?php
}
if($config->get('marketshop_menu_link_hover_bg_color')!='') {?>
#menu .nav > li:hover > a {background-color: <?php echo $config->get('marketshop_menu_link_hover_bg_color'); ?>;}
...
#menu .nav > li + li{border-left:<?php echo $config->get('marketshop_menu_link_separator_size')?>px <?php echo $config->get('marketshop_menu_link_separator_style')?> <?php echo $config->get('marketshop_menu_link_separator_color')?>}
...
#menu{border-top:<?php echo $config->get('marketshop_menu_link_border_top_size')?>px <?php echo $config->get('marketshop_menu_link_border_top_style')?> <?php echo $config->get('marketshop_menu_link_border_top_color')?>}
<?php
}
...
#menu{border-bottom:<?php echo $config->get('marketshop_menu_link_border_bottom_size')?>px <?php echo $config->get('marketshop_menu_link_border_bottom_style')?> <?php echo $config->get('marketshop_menu_link_border_bottom_color')?>}
<?php
}
...
#menu .nav > li.categories_hor > div, #menu .nav > li.categories > div, #menu .nav > li.categories_hor > div .submenu, #menu .nav > li.categories > div > .column > div, #menu .nav > li > .dropdown-menu, #menu .submenu{background-color:<?php echo $config->get('marketshop_sub_menu_background_color'); ?>;}
<?php
}
if($config->get('marketshop_sub_menu_top_border_color')!='') {?>
#menu .nav > li.categories_hor > div, #menu .nav > li.categories > div, #menu .nav > li.categories_hor > div .submenu, #menu .nav > li.categories > div > .column > div, #menu .nav > li > .dropdown-menu, #menu .submenu{border-color:<?php echo $config->get('marketshop_sub_menu_top_border_color'); ?>;}
<?php
}
if($config->get('marketshop_sub_menu_top_border_color')!='') {?>
#menu .nav > li.sub:hover > a:after{border-bottom-color:<?php echo $config->get('marketshop_sub_menu_top_border_color'); ?>;}
<?php
}
if($config->get('marketshop_sub_menu_heading_text_color')!='') {?>
#menu .nav > li.categories_hor > div > .column > a{color:<?php echo $config->get('marketshop_sub_menu_heading_text_color'); ?>;}
<?php
}
...
#menu .nav > li.categories_hor > div > .column > a{border-bottom:1px <?php echo $config->get('marketshop_sub_menu_heading_text_separator_style')?> <?php echo $config->get('marketshop_sub_menu_heading_text_separator_color')?>
}
<?php
}
if($config->get('marketshop_sub_menu_link_color')!='') {?>
#menu .nav > li.categories > div > .column > a, #menu .nav > li div > ul > li > a, #menu .nav > li.menu_brands > div > div a, #menu .custom_block, #menu .custom_block a {color: <?php echo $config->get('marketshop_sub_menu_link_color'); ?>;}
<?php
}
...
#menu .nav > li.categories > div > .column + .column, #menu .nav > li > div > ul li + li, #menu .nav > li.categories > div > .column:hover > div ul li + li, #menu .nav > li.categories_hor > div .submenu ul li + li a {border-top:1px <?php echo $config->get('marketshop_sub_menu_link_separator_style')?> <?php echo $config->get('marketshop_sub_menu_link_separator_color')?>}

<?php
}
if($config->get('marketshop_home_page_link_background_color')!='') {?>
#menu .nav > li > a.home_link {background-color: <?php echo $config->get('marketshop_home_page_link_background_color'); ?>;}
<?php
}
if($config->get('marketshop_home_page_link_background_color_hover')!='') {?>
#menu .nav > li > a.home_link:hover {background-color: <?php echo $config->get('marketshop_home_page_link_background_color_hover'); ?>;}
<?php
}
if($config->get('marketshop_home_page_link_link_color')!='') {?>
#menu .nav > li > a.home_link {color: <?php echo $config->get('marketshop_home_page_link_link_color'); ?>;}
<?php
}
if($config->get('marketshop_home_page_link_link_color_hover')!='') {?>
#menu .nav > li > a.home_link:hover {color: <?php echo $config->get('marketshop_home_page_link_link_color_hover'); ?>;}
<?php
}
if($config->get('marketshop_home_page_link_icon_color')!='') {?>
#menu .nav > li > a.home_link span {background-color: <?php echo $config->get('marketshop_home_page_link_icon_color'); ?>;}
<?php
}
if($config->get('marketshop_home_page_link_icon_color')!='') {?>
#menu .nav > li > a.home_link span:before {border-bottom-color: <?php echo $config->get('marketshop_home_page_link_icon_color'); ?>;}
<?php
}
if($config->get('marketshop_home_page_link_icon_color')!='') {?>
#menu .nav > li > a.home_link span:after {border-color: <?php echo $config->get('marketshop_home_page_link_icon_color'); ?>;}
<?php
}
if($config->get('marketshop_home_page_link_icon_color_hover')!='') {?>
#menu .nav > li > a.home_link:hover span {background-color: <?php echo $config->get('marketshop_home_page_link_icon_color_hover'); ?>;}
<?php
}
if($config->get('marketshop_home_page_link_icon_color_hover')!='') {?>
#menu .nav > li > a.home_link:hover span:before {border-bottom-color: <?php echo $config->get('marketshop_home_page_link_icon_color_hover'); ?>;}
<?php
}
if($config->get('marketshop_home_page_link_icon_color_hover')!='') {?>
#menu .nav > li > a.home_link:hover span:after {border-color: <?php echo $config->get('marketshop_home_page_link_icon_color_hover'); ?>;}


<?php
}
if($config->get('marketshop_categories_section_background_color')!='') {?>
#menu .nav > li.categories_defu > a, #menu .nav > li.categories > a, #menu .nav > li.categories_hor > a {background-color: <?php echo $config->get('marketshop_categories_section_background_color'); ?>;}
<?php
}
if($config->get('marketshop_categories_section_background_color_hover')!='') {?>
#menu .nav > li.categories:hover > a {background-color: <?php echo $config->get('marketshop_categories_section_background_color_hover'); ?>;}
<?php
}
if($config->get('marketshop_categories_section_link_color')!='') {?>
#menu .nav > li.categories > a {color: <?php echo $config->get('marketshop_categories_section_link_color'); ?>;}
<?php
}
if($config->get('marketshop_categories_section_link_color_hover')!='') {?>
#menu .nav > li.categories:hover > a {color: <?php echo $config->get('marketshop_categories_section_link_color_hover'); ?>;}

<?php
}
if($config->get('marketshop_brands_section_background_color')!='') {?>
#menu .nav > li.menu_brands > a {background-color: <?php echo $config->get('marketshop_brands_section_background_color'); ?>;}
<?php
}
if($config->get('marketshop_brands_section_background_color_hover')!='') {?>
#menu .nav > li.menu_brands:hover > a {background-color: <?php echo $config->get('marketshop_brands_section_background_color_hover'); ?>;}
<?php
}
if($config->get('marketshop_brands_section_link_color')!='') {?>
#menu .nav > li.menu_brands > a {color: <?php echo $config->get('marketshop_brands_section_link_color'); ?>;}
<?php
}
if($config->get('marketshop_brands_section_link_color_hover')!='') {?>
#menu .nav > li.menu_brands:hover > a {color: <?php echo $config->get('marketshop_brands_section_link_color_hover'); ?>;}


<?php
}
if($config->get('marketshop_custom_link_section_background_color')!='') {?>
#menu .nav > li.custom-link > a {background-color: <?php echo $config->get('marketshop_custom_link_section_background_color'); ?>;}
<?php
}
if($config->get('marketshop_custom_link_section_background_color_hover')!='') {?>
#menu .nav > li.custom-link:hover > a {background-color: <?php echo $config->get('marketshop_custom_link_section_background_color_hover'); ?>;}
<?php
}
if($config->get('marketshop_custom_link_section_link_color')!='') {?>
#menu .nav > li.custom-link > a {color: <?php echo $config->get('marketshop_custom_link_section_link_color'); ?>;}
<?php
}
if($config->get('marketshop_custom_link_section_link_color_hover')!='') {?>
#menu .nav > li.custom-link:hover > a {color: <?php echo $config->get('marketshop_custom_link_section_link_color_hover'); ?>;}

<?php
}
if($config->get('marketshop_custom_block_section_background_color')!='') {?>
#menu .nav > li.wrap_custom_block > a {background-color: <?php echo $config->get('marketshop_custom_block_section_background_color'); ?>;}
<?php
}
if($config->get('marketshop_custom_block_section_background_color_hover')!='') {?>
#menu .nav > li.wrap_custom_block:hover > a {background-color: <?php echo $config->get('marketshop_custom_block_section_background_color_hover'); ?>;}
<?php
}
if($config->get('marketshop_custom_block_section_link_color')!='') {?>
#menu .nav > li.wrap_custom_block > a {color: <?php echo $config->get('marketshop_custom_block_section_link_color'); ?>;}
<?php
}
if($config->get('marketshop_custom_block_section_link_color_hover')!='') {?>
#menu .nav > li.wrap_custom_block:hover > a {color: <?php echo $config->get('marketshop_custom_block_section_link_color_hover'); ?>;}

<?php
}
if($config->get('marketshop_myaccount_section_background_color')!='') {?>
#menu .nav > li.my-account-link > a {background-color: <?php echo $config->get('marketshop_myaccount_section_background_color'); ?>;}
<?php
}
if($config->get('marketshop_myaccount_section_background_color_hover')!='') {?>
#menu .nav > li.my-account-link:hover > a {background-color: <?php echo $config->get('marketshop_myaccount_section_background_color_hover'); ?>;}
<?php
}
if($config->get('marketshop_myaccount_section_link_color')!='') {?>
#menu .nav > li.my-account-link > a {color: <?php echo $config->get('marketshop_myaccount_section_link_color'); ?>;}
<?php
}
if($config->get('marketshop_myaccount_section_link_color_hover')!='') {?>
#menu .nav > li.my-account-link:hover > a {color: <?php echo $config->get('marketshop_myaccount_section_link_color_hover'); ?>;}

<?php
}
if($config->get('marketshop_information_section_background_color')!='') {?>
#menu .nav > li.information-link > a {background-color: <?php echo $config->get('marketshop_information_section_background_color'); ?>;}
<?php
}
if($config->get('marketshop_information_section_background_color_hover')!='') {?>
#menu .nav > li.information-link:hover > a {background-color: <?php echo $config->get('marketshop_information_section_background_color_hover'); ?>;}
<?php
}
if($config->get('marketshop_information_section_link_color')!='') {?>
#menu .nav > li.information-link > a {color: <?php echo $config->get('marketshop_information_section_link_color'); ?>;}
<?php
}
if($config->get('marketshop_information_section_link_color_hover')!='') {?>
#menu .nav > li.information-link:hover > a {color: <?php echo $config->get('marketshop_information_section_link_color_hover'); ?>;}

<?php
}
if($config->get('marketshop_contact_section_background_color')!='') {?>
#menu .nav > li.contact-link > a {background-color: <?php echo $config->get('marketshop_contact_section_background_color'); ?>;}
<?php
}
if($config->get('marketshop_contact_section_background_color_hover')!='') {?>
#menu .nav > li.contact-link:hover > a {background-color: <?php echo $config->get('marketshop_contact_section_background_color_hover'); ?>;}
<?php
}
if($config->get('marketshop_contact_section_link_color')!='') {?>
#menu .nav > li.contact-link > a {color: <?php echo $config->get('marketshop_contact_section_link_color'); ?>;}
<?php
}
if($config->get('marketshop_contact_section_link_color_hover')!='') {?>
#menu .nav > li.contact-link:hover > a {color: <?php echo $config->get('marketshop_contact_section_link_color_hover'); ?>;}

<?php
}
if($config->get('marketshop_custom_link_right_background_color')!='') {?>
#menu .nav > li.custom-link-right > a {background-color: <?php echo $config->get('marketshop_custom_link_right_background_color'); ?>;}
<?php
}
if($config->get('marketshop_custom_link_right_background_color_hover')!='') {?>
#menu .nav > li.custom-link-right:hover > a {background-color: <?php echo $config->get('marketshop_custom_link_right_background_color_hover'); ?>;}
<?php
}
if($config->get('marketshop_custom_link_right_link_color')!='') {?>
#menu .nav > li.custom-link-right > a {color: <?php echo $config->get('marketshop_custom_link_right_link_color'); ?>;}
<?php
}
if($config->get('marketshop_custom_link_right_link_color_hover')!='') {?>
#menu .nav > li.custom-link-right:hover > a {color: <?php echo $config->get('marketshop_custom_link_right_link_color_hover'); ?>;}


<?php
}
if($config->get('marketshop_custom_block_bg_color')!='') {?>
.custom_side_block_icon{background-color: <?php echo $config->get('marketshop_custom_block_bg_color'); ?>;}
<?php
}
if($config->get('marketshop_custom_block_bg_color')!='') {?>
#custom_side_block{border-color: <?php echo $config->get('marketshop_custom_block_bg_color'); ?>;}
...
#footer .fpart-first {background-color: <?php echo $config->get('marketshop_footer_bg_color'); ?>;}
<?php
}
if($config->get('marketshop_footer_titles_color')!='') {?>
#footer h5 {color: <?php echo $config->get('marketshop_footer_titles_color'); ?>;}
<?php
}
if($config->get('marketshop_footer_text_color')!='') {?>
#footer .fpart-first {color: <?php echo $config->get('marketshop_footer_text_color'); ?>;}
<?php
}
if($config->get('marketshop_footer_link_color')!='') {?>
#footer .fpart-first a {color: <?php echo $config->get('marketshop_footer_link_color'); ?>;}
<?php
}
if($config->get('marketshop_footer_link_hover_color')!='') {?>
#footer .fpart-first a:hover {color: <?php echo $config->get('marketshop_footer_link_hover_color'); ?>;}
<?php
}
if($config->get('marketshop_contact_icon_color')!='') {?>
#footer .contact > ul > li > .fa {color: <?php echo $config->get('marketshop_contact_icon_color'); ?>;}
<?php
}
if($config->get('marketshop_footer_second_bg_color')!='') {?>
#footer .fpart-second {background-color: <?php echo $config->get('marketshop_footer_second_bg_color'); ?>;}
<?php
}
if($config->get('marketshop_footer_second_text_color')!='') {?>
#footer .fpart-second {color: <?php echo $config->get('marketshop_footer_second_text_color'); ?>;}
 <?php
}
if($config->get('marketshop_footer_second_link_color')!='') {?>
#footer .fpart-second a {color: <?php echo $config->get('marketshop_footer_second_link_color'); ?>;}
<?php
}
if($config->get('marketshop_footer_second_link_hover_color')!='') {?>
#footer .fpart-second a:hover {color: <?php echo $config->get('marketshop_footer_second_link_hover_color'); ?>;}
<?php
}
if(($config->get('marketshop_footer_second_separator_color')!='') && ($config->get('marketshop_footer_second_separator_style')!='')) {
?>#footer #powered {border-bottom:<?php echo $config->get('marketshop_footer_second_separator_size')?>px <?php echo $config->get('marketshop_footer_second_separator_style')?> <?php echo $config->get('marketshop_footer_second_separator_color')?>}
<?php
}
if($config->get('marketshop_footer_backtotop_bg_color')!='') {?>
#back-top a:hover {background-color: <?php echo $config->get('marketshop_footer_backtotop_bg_color'); ?>;}

/*===== PRICE =====*/
<?php
}
if($config->get('marketshop_price_color')!='') {?>
.product-thumb .price, .product-info .price{color: <?php echo $config->get('marketshop_price_color'); ?>;}
<?php
}
if($config->get('marketshop_old_price_color')!='') {?>
.product-thumb .price-old, .product-info .price-old{color: <?php echo $config->get('marketshop_old_price_color'); ?>;}
<?php
}
if($config->get('marketshop_new_price_color')!='') {?>
.product-thumb .price-new{color: <?php echo $config->get('marketshop_new_price_color'); ?>;}
<?php
}
if($config->get('marketshop_tax_price_color')!='') {?>
.product-info .price-tax, .product-thumb .price .price-tax{color: <?php echo $config->get('marketshop_tax_price_color'); ?>;}
<?php
}
if($config->get('marketshop_saving_percentage_bg_color')!='') {?>
.saving{background-color: <?php echo $config->get('marketshop_saving_percentage_bg_color'); ?>;}
<?php
}
if($config->get('marketshop_saving_percentage_text_color')!='') {?>
.saving {color: <?php echo $config->get('marketshop_saving_percentage_text_color'); ?>;}

/*===== BUTTON =====*/
<?php
}
if($config->get('marketshop_button_bg_color')!='') {?>
.btn-primary {background-color: <?php echo $config->get('marketshop_button_bg_color'); ?>;}
<?php
}
if($config->get('marketshop_button_bg_hover_color')!='') {?>
.btn-primary:hover, .btn-primary:active, .btn-primary.active, .btn-primary.disabled, .btn-primary[disabled] {background-color: <?php echo $config->get('marketshop_button_bg_hover_color'); ?>;}
<?php
}
if($config->get('marketshop_button_text_color')!='') {?>
.btn-primary {color: <?php echo $config->get('marketshop_button_text_color'); ?>;}
<?php
}
if($config->get('marketshop_button_text_hover_color')!='') {?>
.btn-primary:hover, .btn-primary:active, .btn-primary.active, .btn-primary.disabled, .btn-primary[disabled] {color: <?php echo $config->get('marketshop_button_text_hover_color'); ?>;}

/*===== DEFAULT BUTTON =====*/
<?php
}
if($config->get('marketshop_default_button_bg_color')!='') {?>
.btn-default {background-color: <?php echo $config->get('marketshop_default_button_bg_color'); ?>;}
<?php
}
if($config->get('marketshop_default_button_bg_hover_color')!='') {?>
.btn-default:hover{background-color: <?php echo $config->get('marketshop_default_button_bg_hover_color'); ?>;}
<?php
}
if($config->get('marketshop_default_button_text_color')!='') {?>
.btn-default{color: <?php echo $config->get('marketshop_default_button_text_color'); ?>;}
<?php
}
if($config->get('marketshop_default_button_text_hover_color')!='') {?>
.btn-default:hover{color: <?php echo $config->get('marketshop_default_button_text_hover_color'); ?>;}

/*===== AddToCart BUTTONS =====*/
<?php
}
if($config->get('marketshop_cart_button_bg_color')!='') {?>
.product-thumb .button-group button {background-color: <?php echo $config->get('marketshop_cart_button_bg_color'); ?>;}
<?php
}
if($config->get('marketshop_cart_button_bg_hover_color')!='') {?>
.product-thumb .button-group button:hover{background-color: <?php echo $config->get('marketshop_cart_button_bg_hover_color'); ?>;
}
<?php
}
if($config->get('marketshop_cart_button_text_color')!='') {?>
.product-thumb .button-group button {color: <?php echo $config->get('marketshop_cart_button_text_color');?>;}
<?php
}
if($config->get('marketshop_cart_button_text_hover_color')!='') {?>
.product-thumb .button-group button:hover{color: <?php echo $config->get('marketshop_cart_button_text_hover_color');?>;}

/*===== Exclusive BUTTONS =====*/
<?php
}
if($config->get('marketshop_excl_button_bg_color')!='') {?>
.product-info .cart #button-cart {background-color: <?php echo $config->get('marketshop_excl_button_bg_color'); ?>;}
<?php
}
if($config->get('marketshop_excl_button_bg_hover_color')!='') {?>
.product-info .cart #button-cart:hover {background-color: <?php echo $config->get('marketshop_excl_button_bg_hover_color'); ?>;}
 <?php
}
if($config->get('marketshop_excl_button_text_color')!='') {?>
.product-info .cart #button-cart {color: <?php echo $config->get('marketshop_excl_button_text_color'); ?>;}
<?php
}
if($config->get('marketshop_excl_button_text_hover_color')!='') {?>
.product-info .cart #button-cart:hover {color: <?php echo $config->get('marketshop_excl_button_text_hover_color'); ?>;}

<?php
}
if($config->get('marketshop_feature_box1_bg_color')!='') {?>
.custom-feature-box .feature-box.fbox_1 {background: <?php echo $config->get('marketshop_feature_box1_bg_color');?>;}
<?php
}
if($config->get('marketshop_feature_box1_title_color')!='') {?>
.custom-feature-box .feature-box.fbox_1 .title {color: <?php echo $config->get('marketshop_feature_box1_title_color');?>;}
<?php
}
if($config->get('marketshop_feature_box1_subtitle_color')!='') {?>
.custom-feature-box .feature-box.fbox_1 p {color: <?php echo $config->get('marketshop_feature_box1_subtitle_color');?>;}
...
.custom-feature-box .feature-box.fbox_2 {background: <?php echo $config->get('marketshop_feature_box2_bg_color');?>;}
<?php
}
if($config->get('marketshop_feature_box2_title_color')!='') {?>
.custom-feature-box .feature-box.fbox_2 .title {color: <?php echo $config->get('marketshop_feature_box2_title_color');?>;}
<?php
}
if($config->get('marketshop_feature_box2_subtitle_color')!='') {?>
.custom-feature-box .feature-box.fbox_2 p {color: <?php echo $config->get('marketshop_feature_box2_subtitle_color');?>;}
...
.custom-feature-box .feature-box.fbox_3 {background: <?php echo $config->get('marketshop_feature_box3_bg_color');?>;}
<?php
}
if($config->get('marketshop_feature_box3_title_color')!='') {?>
.custom-feature-box .feature-box.fbox_3 .title {color: <?php echo $config->get('marketshop_feature_box3_title_color');?>;}
<?php
}
if($config->get('marketshop_feature_box3_subtitle_color')!='') {?>
.custom-feature-box .feature-box.fbox_3 p {color: <?php echo $config->get('marketshop_feature_box3_subtitle_color');?>;}
...
.custom-feature-box .feature-box.fbox_4 {background: <?php echo $config->get('marketshop_feature_box4_bg_color');?>;}
<?php
}
if($config->get('marketshop_feature_box4_title_color')!='') {?>
.custom-feature-box .feature-box.fbox_4 .title {color: <?php echo $config->get('marketshop_feature_box4_title_color');?>;}
<?php
}
if($config->get('marketshop_feature_box4_subtitle_color')!='') {?>
.custom-feature-box .feature-box.fbox_4 p {color: <?php echo $config->get('marketshop_feature_box4_subtitle_color');?>;}
<?php
}
if($config->get('marketshop_feature_box_title_font_size')!='') {?>
.custom-feature-box .feature-box .title {font-size:<?php echo $config->get('marketshop_feature_box_title_font_size');?>;}
<?php
}
if($config->get('marketshop_feature_box_title_font_weight')!='') {?>
.custom-feature-box .feature-box .title {font-weight:<?php echo $config->get('marketshop_feature_box_title_font_weight');?>;}
<?php
}
if($config->get('marketshop_feature_box_title_font_transform')!='') {?>
.custom-feature-box .feature-box .title {text-transform:<?php echo $config->get('marketshop_feature_box_title_font_transform');?>;}

<?php
}
if($config->get('marketshop_feature_box_subtitle_font_size')!='') {?>
.custom-feature-box .feature-box p {font-size:<?php echo $config->get('marketshop_feature_box_subtitle_font_size');?>;}
<?php
}
if($config->get('marketshop_feature_box_subtitle_font_weight')!='') {?>
.custom-feature-box .feature-box p {font-weight:<?php echo $config->get('marketshop_feature_box_subtitle_font_weight');?>;}
<?php
}
if($config->get('marketshop_feature_box_subtitle_font_transform')!='') {?>
.custom-feature-box .feature-box p {text-transform:<?php echo $config->get('marketshop_feature_box_subtitle_font_transform');?>;}
...
#container h1 {font-size:<?php echo $config->get('marketshop_title_font_size');?>;}
<?php
}
if($config->get('marketshop_title_font_weight')!='') {?>
#container h1{font-weight:<?php echo $config->get('marketshop_title_font_weight');?>;}
<?php
}
if($config->get('marketshop_title_font_uppercase')!='') {?>
#container h1 {text-transform:<?php echo $config->get('marketshop_title_font_uppercase');?>;}
<?php
}
...
#menu .nav > li > a {font-size:<?php echo $config->get('marketshop_main_menu_font_size');?>;}
<?php
}
if($config->get('marketshop_main_menu_font_weight')!='') {?>
#menu .nav > li > a {font-weight:<?php echo $config->get('marketshop_main_menu_font_weight');?>;}
<?php
}
if($config->get('marketshop_main_menu_font_uppercase')!='') {?>
#menu .nav > li > a {text-transform:<?php echo $config->get('marketshop_main_menu_font_uppercase');?>;}
<?php
}
...
#header .links > ul > li.mobile, #header #top-links > ul > li > a, #header .links ul li a, #language span, #currency span, #header .links .wrap_custom_block > a {font-size:<?php echo $config->get('marketshop_top_bar_font_size');?>;}
<?php
}
if($config->get('marketshop_top_bar_font_weight')!='') {?>
#header #top-links > ul > li > a, #header .links ul li a, #language span, #currency span, #header .links .wrap_custom_block > a {font-weight:<?php echo $config->get('marketshop_top_bar_font_weight');?>;}
<?php
}
if($config->get('marketshop_top_bar_font_uppercase')!='') {?>
#header #top-links > ul > li > a, #header .links ul li a, #language span, #currency span, #header .links .wrap_custom_block > a {text-transform:<?php echo $config->get('marketshop_top_bar_font_uppercase');?>;}
<?php
}
 if($config->get('marketshop_secondary_titles_font')!='') {
 $fontpre = $config->get('marketshop_secondary_titles_font');
 $font = str_replace("+", " ", $fontpre);
 ?>#container h2, #container h3, .product-tab .htabs a, .product-tab .tabs li a{font-family:<?php echo $font ?>;}
<?php
}
if($config->get('marketshop_secondary_titles_font_size')!='') {?>
#container h2, #container h3, .product-tab .htabs a, .product-tab .tabs li a {font-size:<?php echo $config->get('marketshop_secondary_titles_font_size');?>;}
<?php
}
if($config->get('marketshop_secondary_titles_font_weight')!='') {?>
#container h2, #container h3, .product-tab .htabs a, .product-tab .tabs li a{font-weight:<?php echo $config->get('marketshop_secondary_titles_font_weight');?>;}
<?php
}
if($config->get('marketshop_secondary_titles_font_uppercase')!='') {?>
#container h2, #container h3, .product-tab .htabs a, .product-tab .tabs li a {text-transform:<?php echo $config->get('marketshop_secondary_titles_font_uppercase');?>;}
<?php
}
 if($config->get('marketshop_footer_titles_font')!='') {
 $fontpre = $config->get('marketshop_footer_titles_font');
 $font = str_replace("+", " ", $fontpre); ?>
 #footer h5{font-family:<?php echo $font ?>;}
 <?php
}
if($config->get('marketshop_footer_titles_font_size')!='') {?>
#footer h5{font-size:<?php echo $config->get('marketshop_footer_titles_font_size');?>;}
<?php
}
if($config->get('marketshop_footer_titles_font_weight')!='') {?>
#footer h5{font-weight:<?php echo $config->get('marketshop_footer_titles_font_weight');?>;}
<?php
}
if($config->get('marketshop_footer_titles_font_uppercase')!='') {?>
#footer h5{text-transform:<?php echo $config->get('marketshop_footer_titles_font_uppercase');?>;}
<?php
}
...
<?php 
if($config->get('marketshop_top_bar_bg_color')!='') {?>
.left-top{background-color:<?php echo $config->get('marketshop_top_bar_bg_color'); ?>;}
<?php }
if($config->get('marketshop_menu_link_color')!='') {?>
#menu > span {color: <?php echo $config->get('marketshop_menu_link_color'); ?>;}
<?php }
if($config->get('marketshop_menu_link_color')!='') {?>
#menu > span:before{border-bottom-color: <?php echo $config->get('marketshop_menu_link_color'); ?>;}
<?php }
if($config->get('marketshop_menu_link_color')!='') {?>
#menu > span:after{border-top-color: <?php echo $config->get('marketshop_menu_link_color'); ?>;}
<?php }
if(($config->get('marketshop_menu_link_border_bottom_size')!='') && ($config->get('marketshop_menu_link_border_bottom_style')!='') && ($config->get('marketshop_menu_link_border_bottom_color')!='') && ($config->get('marketshop_menu_link_border_bottom_status') ==1)) {?>
#menu .nav{border-top:<?php echo $config->get('marketshop_menu_link_border_bottom_size')?>px <?php echo $config->get('marketshop_menu_link_border_bottom_style')?> <?php echo $config->get('marketshop_menu_link_border_bottom_color')?>}<?php } ?>
}
</style>
...
<?php if($config->get('marketshop_layout_style')== 1) { ?><section class="wrapper-wide"><?php } else { ?><section class="wrapper-box"><?php } ?>
<?php if($config->get('marketshop_header_style')== 1) { ?><div id="header" ><?php } ?>
<?php if($config->get('marketshop_header_style')== 2) { ?><div id="header" class="style2"><?php } ?>
<?php if($config->get('marketshop_header_style')== 3) { ?><div id="header" class="style3"><?php } ?>
...
<?php if($config->get('marketshop_custom_link1_top')== 1) {
     ...
     <li><a href="<?php echo $config->get('marketshop_custom_link1_top_url'); ?>" target="<?php echo $config->get('marketshop_target_link1_top'); ?>">
    ...
    <?php if($config->get('marketshop_custom_link2_top')== 1) {
     ...
     <li><a href="<?php echo $config->get('marketshop_custom_link2_top_url'); ?>" target="<?php echo $config->get('marketshop_target_link2_top'); ?>">
    ...
    <?php if($config->get('marketshop_custom_link3_top')== 1) {
     ...
     <li><a href="<?php echo $config->get('marketshop_custom_link3_top_url'); ?>" target="<?php echo $config->get('marketshop_target_link3_top'); ?>">
    ...
    <?php } ?><?php } ?>
    <?php if($config->get('marketshop_wishlist_top_link')== 1) { ?><li><a href="<?php echo $wishlist; ?>" id="wishlist-total"><?php echo $text_wishlist; ?></a></li><?php } ?>
    <?php if($config->get('marketshop_checkout_top_link')== 1) { ?><li><a href="<?php echo $checkout; ?>"><?php echo $text_checkout; ?></a></li><?php } ?>
    </ul>
    </div>
    <?php echo $language; ?>
<?php echo $currency; ?>
...
<?php if($config->get('marketshop_main_menu_style')== 2) { ?><div class="container"><?php } ?>
  <nav id="menu" class="navbar">
  
 <div class="navbar-header">
 <span class="visible-xs visible-sm" data-target=".navbar-ex1-collapse" data-toggle="collapse" ><?php if($config->get('marketshop_status')== 1) {
...
<?php if($config->get('marketshop_main_menu_style')== 1) { ?><div class="container"><?php } ?>
  ...
  <ul class="nav navbar-nav">
    <?php if($config->get('marketshop_home_page_link')== 1) { ?>
      ...
      <?php if($config->get('marketshop_home_page_link_icon')== 1) { ?><?php echo $text_home; ?><?php } else { ?><span><?php echo $text_home; ?></span><?php } ?>
      </a></li>
...
<?php if($config->get('marketshop_custom_link1')== 1) {
     ...
     <li class="custom-link"><a href="<?php echo $config->get('marketshop_custom_link1_url'); ?>" target="<?php echo $config->get('marketshop_target_link1'); ?>">
...
<?php if($config->get('marketshop_custom_link2')== 1) {
     ...
     <li class="custom-link"><a href="<?php echo $config->get('marketshop_custom_link2_url'); ?>" target="<?php echo $config->get('marketshop_target_link2'); ?>">
    ...
    <?php if($config->get('marketshop_custom_link3')== 1) {
     ...
     <li class="custom-link"><a href="<?php echo $config->get('marketshop_custom_link3_url'); ?>" target="<?php echo $config->get('marketshop_target_link3'); ?>">
    ...
    <?php if($config->get('marketshop_custom_link4')== 1) {
     ...
     <li class="custom-link"><a href="<?php echo $config->get('marketshop_custom_link4_url'); ?>" target="<?php echo $config->get('marketshop_target_link4'); ?>">
    ...
    <?php if($config->get('marketshop_custom_link5')== 1) {
     ...
     <li class="custom-link"><a href="<?php echo $config->get('marketshop_custom_link5_url'); ?>" target="<?php echo $config->get('marketshop_target_link5'); ?>">
   ...
   if ($informations) { ?>
     ...
     <li class="custom-link-right"><a href="<?php echo $config->get('marketshop_custom_link_right_url'); ?>" target="<?php echo $config->get('marketshop_custom_link_right_target'); ?>">
  ...
  <?php if($config->get('marketshop_main_menu_style')== 1) { ?></div><?php } ?>
    
  </nav>
<?php if($config->get('marketshop_main_menu_style')== 2) { ?></div><?php } ?>
</div>
